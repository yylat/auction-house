...
-- Dumping data for table auction_house.bid: ~0 rows (approximately)
DELETE FROM `bid`;
...
-- Dumping data for table auction_house.delivery_status: ~0 rows (approximately)
...
-- Dumping data for table auction_house.item: ~0 rows (approximately)
DELETE FROM `item`;
...
-- Dumping data for table auction_house.item_category: ~0 rows (approximately)
...
-- Dumping data for table auction_house.item_status: ~0 rows (approximately)
...
DROP EVENT IF EXISTS `item_status_update`;
DELIMITER //
...
-- Dumping data for table auction_house.notification: ~0 rows (approximately)
...
-- Dumping data for table auction_house.notification_type: ~0 rows (approximately)
...
-- Dumping data for table auction_house.photo: ~0 rows (approximately)
DELETE FROM `photo`;
/*!40000 ALTER TABLE `photo` DISABLE KEYS */;
/*!40000 ALTER TABLE `photo` ENABLE KEYS */;

-- Dumping structure for procedure auction_house.set_delivery_date
DROP PROCEDURE IF EXISTS `set_delivery_date`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `update_previous_winning_bid`;
DELIMITER //
...
-- Dumping data for table auction_house.user: ~0 rows (approximately)
DELETE FROM `user`;
...
-- Dumping data for table auction_house.user_role: ~0 rows (approximately)
...
DROP TRIGGER IF EXISTS `bid_after_update`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `item_before_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
DROP TRIGGER IF EXISTS `notification_before_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
